...
import CorporateTrainingSecton from "@/components/training/corporate-training-section";
import CustomiseTrainingSecton from "@/components/training/customise-training-section";

export const metadata: Metadata = {
  title: "Customise Training",
};
    ...
    <Wrapper>
      <div className="main-page-wrapper">
        ...
        <main>
          ...
          <BreadcrumbOne 
          title="Customise Training"
          subtitle="Best Customic Training Companies & Corporate Trainers in 2024."
          page="Customise Training"
          bg_img={about_bg}
          // // shape={shape}
          style_2={true}
          />
